# TODO
1. Mutators:
    1. add a meter type similar to sequential but scoring to solve first output in all tests first then second output in all tests then third and so on.
...
11. Change test cases to use decimal instead of integer
12. QM's ToText and FromText is spread around - it should be close by